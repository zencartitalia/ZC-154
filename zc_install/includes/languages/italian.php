...
define('TEXT_VERSION_CHECK_DOWNLOAD', 'Scarica qui');
define('TEXT_VERSION_CHECK_CURRENT', 'La tua versione di Zen Cart&reg; sembra essere l\'ultima disponibile.');
define('TEXT_ERROR_NEW_VERSION_AVAILABLE', '<a href="http://www.zen-cart.it/getit">Una NUOVA versione di Zen Cart&reg; è disponibile, può essere scaricata da </a><a href="http://www.zen-cart.it" style="text-decoration:underline" target="_blank">www.zen-cart.it</a>');
define('LABEL_ZC_VERSION_CHECK', 'Versione Zen Cart:');
