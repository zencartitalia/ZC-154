...
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Zen Cart ITALIA', 'http://www.zen-cart.it', 'banners/zen-cart-it.gif', 'Footer_3', '', NULL, NULL, NULL, '2004-01-11 20:59:12', '2014-07-30 20:49:53', 1, 1, 1, 0);
...
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato A', 'https://www.facebook.com/zencartitalia', 'banners/zencart-2014-a.gif', 'Header_2', '', NULL, NULL, NULL, '2012-04-07 18:33:47', '2014-07-30 20:45:49', 1, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato B', 'http://twitter.com/#!/zencartitalia', 'banners/zencart-2014-b.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:46:32', '2014-07-30 20:48:13', 1, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato C', 'https://plus.google.com/115239847124335172426', 'banners/zencart-2014-c.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:47:03', '2014-07-30 20:48:00', 1, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato D', 'http://www.youtube.com/zencartitalia', 'banners/zencart-2014-d.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:47:40', '2014-07-30 20:47:41', 1, 1, 1, 0);
INSERT INTO banners (banners_title, banners_url, banners_image, banners_group, banners_html_text, expires_impressions, expires_date, date_scheduled, date_added, date_status_change, status, banners_open_new_windows, banners_on_ssl, banners_sort_order) VALUES ('Collegato E', 'http://zencart.tumblr.com/', 'banners/zencart-2014-e.gif', 'Header_2', '', NULL, NULL, NULL, '2014-07-30 20:49:08', '2014-07-30 20:49:08', 1, 1, 1, 0);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Telefono - Servizio Clienti', 'STORE_TELEPHONE_CUSTSERVICE', '', 'Numero di telefono del Servizio Clienti. Questo numero &egrave; mostrato ai clienti durante le transazioni dei pagamenti.', '1', '3', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('PA-DSS Attivare il Checkout ajax?', 'PADSS_AJAX_CHECKOUT', '1', 'La conformità alla certificazione PA-DSS prevede che per alcuni sistemi di pagamento si usi ajax per la schermata di cnoferma ordine. Sebbene questo venga attivato solo in caso sia presente uno di questi sistemi di pagamento, qualcuno potrebbe desiderare il tradizionale flusso di checkout <strong>Se si disabilitail checkout ajax, il sito diventa NON CONFORME alle regole PA-DSS, invalidando così la certificazione.</strong>', 1, 30, now(), now(), NULL, 'zen_cfg_select_drop_down(array(array(\'id\'=>\'0\', \'text\'=>\'Non-Compliant\'), array(\'id\'=>\'1\', \'text\'=>\'On\')),');

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) VALUES ('Admin - Time Out Sessione in Secondi', 'SESSION_TIMEOUT_ADMIN', '900', 'Inserisci il tempo in secondi.<br />Massimo consentito &egrave; 900 in ossequio ai requisiti PCI.<br /> Default=900<br />Esempio: 900= 15 min <br /><br />Nota: Troppo pochi secondi possono dare come conseguenza problemi di timeout ad esempio durante l\'inserimento/modifica dei prodotti', '1', '40', NULL, now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Editor HTML', 'HTML_EDITOR_PREFERENCE', 'CKEDITOR', 'Definire un editor HTML/Testo da utilizzare per comporre email, newsletter e descrizioni prodotti in Admin', '1', '110', 'zen_cfg_pull_down_htmleditors(', now());
#phpbb
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Mostra lo status di prodotto linkato', 'SHOW_CATEGORY_PRODUCTS_LINKED_STATUS', 'true', 'Mostrare, in admin, se il prodotto è linkato in altre categorie?', '1', '19', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Abilita Ritiro Merce presso il Negozio', 'MODULE_SHIPPING_STOREPICKUP_STATUS', 'True', 'Abilitare la possibilit&agrave; di ritirare la merce presso la sede del Negozio?', '6', '0', now(), NULL, 'zen_cfg_select_option(array(\'True\', \'False\'), ');
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Costi di Spedizione', 'MODULE_SHIPPING_STOREPICKUP_COST', '0.00', 'Le Spese di Spedizione per tutti gli ordini che utilizzano questo metodo di spedizione.', '6', '0', now(), NULL, NULL);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) VALUES ('Zona di Spedizione', 'MODULE_SHIPPING_STOREPICKUP_ZONE', '0', 'Se viene selezionata una Zona, attiva questo metodo di spedizione soltanto per questa Zona.', '6', '0', now(), 'zen_get_zone_class_title', 'zen_cfg_pull_down_zone_classes(');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Visualizza Page Parse Time', 'DISPLAY_PAGE_PARSE_TIME', 'false', 'Visualizza il Page Parse Time nella parte inferiore di ogni pagina.<br />Non &egrave; necessario memorizzare i tempi per visualizzarli nel Catalogo.', '10', '4', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Memorizza le query sql', 'STORE_DB_TRANSACTIONS', 'false', 'Salva (log) le query al db su files contenuti nella cartella /logs/. ATTENZIONE, USARE CON CAUTELA. Può degradare seriamente le performance del sito e esaurire rapidamente lo spazio disponibile.<br><strong>Attivando questa impostazione si rende il sito NON CONFORME alle regole PCI DSS, invalidando così qualsiasi certificazione.', '10', '5', 'zen_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Abilita invio e-mail in HTML?', 'EMAIL_USE_HTML', 'false', 'Invia le e-mail in formato HTML se il ricevente ha acconsentito nelle sue preferenze.', '12', '3', 'zen_cfg_select_option(array(\'true\', \'false\'),', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function) VALUES ('Formato Email Admin?', 'ADMIN_EXTRA_EMAIL_FORMAT', 'TEXT', 'Per favore seleziona il formato delle email Admin extra (Nota: per selezionare HTML, deve essere attiva l\'opzione di invio mail in HTML).', 12, 12, NULL, 'zen_cfg_select_option(array(\'TEXT\', \'HTML\'), ');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Cartella Sessioni', 'SESSION_WRITE_DIRECTORY', '/tmp', 'Questo deve corrispondere alla cartella specificata nel file configure.php, define DIR_FS_SQL_CACHE.', '15', '1', now());
...
# ITALIA
INSERT INTO tax_rates VALUES (1, 1, 1, 1, 22.0, 'IVA 22.0%', now(), now());
INSERT INTO geo_zones (geo_zone_id,geo_zone_name,geo_zone_description,date_added) VALUES (1,'Italia','IVA Italia',now());
INSERT INTO zones_to_geo_zones (association_id,zone_country_id,zone_id,geo_zone_id,date_added) VALUES (1,105,NULL,1,now());
INSERT INTO tax_class (tax_class_id, tax_class_title, tax_class_description, date_added) VALUES (1, 'Beni 22 % IVA', 'Beni e servizi a cui applicare il 22 % IVA', now());
...
INSERT INTO query_builder (query_id, query_category, query_name, query_description, query_string, query_keys_list) VALUES ('5', 'email,newsletters', 'Clienti Attivi negli ultimi 3 mesi (non in base allo stato di abbonamento)', 'Tutti i Clienti Attivi (hanno comprato qualcosa) negli ultimi 3 mesi, senza considerare lo stato di abbonamento alla newsletter.', 'select c.customers_email_address, c.customers_lastname, c.customers_firstname from TABLE_CUSTOMERS c, TABLE_ORDERS o WHERE c.customers_id = o.customers_id and o.date_purchased > subdate(now(),INTERVAL 3 MONTH) GROUP BY c.customers_email_address order by c.customers_lastname, c.customers_firstname ASC', '');
INSERT INTO query_builder (query_id, query_category, query_name, query_description, query_string, query_keys_list) VALUES ('6', 'email,newsletters', 'Amministratore', 'Solo account email attuale Amministratore.', 'select \'ADMIN\' as customers_firstname, admin_name as customers_lastname, admin_email as customers_email_address from TABLE_ADMIN where admin_id = $SESSION:admin_id', '');
...
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '5.4', '', '', '', '', 'Nuova installazione', now());
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '5.4', '', '', '', '', 'Nuova installazione', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '5.4', '', 'Nuova installazione', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '5.4', '', 'Nuova installazione', now());
