 ...
 * @version Id: italian.php 2015-01-05 12:48 Author: Paolo De Dionigi aka Spike00 Modified in v1.5.4
*/
...
define('TEXT_WARNING_HTML_DISABLED','<span class = "main">Nota: stai utilizzando email in formato TESTO. Per utilizzare HTML dovrai abilitare "Abilita Email HTML" nelle Opzioni Email</span>');
define('TEXT_WARNING_CANT_DISPLAY_HTML','<span class = "main">Nota: stai utilizzando email in formato TESTO. Per utilizzare HTML dovrai abilitare "Abilita Email HTML" nelle Opzioni Email</span>');
...
define('TEXT_ACTIVITY_LOG_ACCESSED', 'Accesso LOG attività admin. Formato output: %s. Filtro: %s. %s');
define('TEXT_ERROR_FAILED_ADMIN_LOGIN_FOR_USER', 'Tentativo fallito di login in admin: ');
define('TEXT_ERROR_ATTEMPTED_TO_LOG_IN_TO_LOCKED_ACCOUNT', 'Tentativo di login con un account sospeso:');
define('TEXT_ERROR_ATTEMPTED_ADMIN_LOGIN_WITHOUT_CSRF_TOKEN', 'Tentativo di login senza l\'uso del token CSRF.');
define('TEXT_ERROR_ATTEMPTED_ADMIN_LOGIN_WITHOUT_USERNAME', 'Tentativo di login senza username.');
define('TEXT_ERROR_INCORRECT_PASSWORD_DURING_RESET_FOR_USER', 'Password errata durante un tentativo di reset password per: ');
...
define('ERROR_DATABASE_MAINTENANCE_NEEDED', '<a href="http://www.zen-cart.it/faq/altri-errori/145-errore-0071-problema-con-il-database" target="_blank">ERRORE 0071: Sembra esserci un problema con il database. &Egrave; necessario porre in manutenzione il negozio.</a>');
